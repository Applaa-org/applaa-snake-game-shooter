...
func _setup_theme():
	...
	button_style.bg_color = Color(0.8, 0.2, 0.2)
	button_style.border_width_left = 2
	button_style.border_width_right = 2
	button_style.border_width_top = 2
	button_style.border_width_bottom = 2
	button_style.border_color = Color(0.4, 0.1, 0.1)
	...
	pressed_style.bg_color = Color(0.6, 0.1, 0.1)
	theme.set_stylebox("pressed", "Button", pressed_style)
	
	# Label styling
	var label_color = Color(0.8, 0.2, 0.2)
